...
# Сообщения
MESSAGE_1 = (
    "Настало время узнать правду, возможно горькую, но правду\\.\\n\\n"
    ...
    "[Читать статью](https://teletype.in/@taro_venger/681h3YQO3Cg)"
)
bot.send_message(chat_id, MESSAGE_1, parse_mode="MarkdownV2")
